...
public class PathExpressionsTest extends EntityManagerTest {
    ...
    public void buscarPedidosComProdutoDeIDIgual1Exercicio() {
        ...
        Join<Pedido, ItemPedido> pedidoItemPedidoJoin = root.join(Pedido_.itens);

        criteriaQuery.select(root);

        criteriaQuery.where(criteriaBuilder.equal(pedidoItemPedidoJoin.get(ItemPedido_.produto).get(Produto_.ID), 1));
